...
@FeatureConstructorRegistry.register("flag")
class FlagFeatureConstructor(BaseFeatureConstructor):
    ...
    def construct(
        ...
        p_obs = self._construct_p_net_features(
            p_net,
            v_net,
            solution,
            curr_v_node_id,
        ...
        v_obs = self._construct_v_net_features(
            p_net,
            v_net,
            solution,
            curr_v_node_id,
        ...
        obs = {
            ...
            "curr_v_node_id": int(curr_v_node_id),
