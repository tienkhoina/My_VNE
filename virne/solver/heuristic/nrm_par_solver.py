...
@SolverRegistry.register('nrm_par', solver_type='heuristic')
class NRMParSolver(Solver):
    ...
    def solve(self, instance):
        ...
        for step_id, v_node in enumerate(sorted_v_nodes):
            ...
            for p_node in p_candidates:
                ...
                # (C) final score
                score = s_value * dist_penalty
                p_candidate_scores[p_node] = score

                if self.debug:
                    debug_list.append((p_node, s_value, dist_penalty, score))
